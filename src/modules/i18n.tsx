...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    // Voxel Relief / IA
    relief_classic: "Flat Overlay (Classic)",
    relief_ai: "3D Voxel Relief (IA)",
    openai_key_label: "OpenAI API Key",
    openai_key_placeholder: "sk-proj-...",
    btn_generate_relief: "Generate Relief with IA",
    btn_generating_relief: "Generating Relief...",
    toast_api_key_required: "An OpenAI API Key is required to generate relief.",
    toast_ai_relief_success: "Custom 3D voxel relief generated successfully!",
    toast_ai_relief_error: "Error generating AI relief: {error}",
    relief_description: "Enter your OpenAI API key to automatically calculate voxel depths using GPT-4o-mini. The key is stored locally in your browser and sent directly to OpenAI.",
    relief_export_note: "Note: The 3D relief will be exported in OBJ, FBX, and GLB formats. BBModel exports will remain in classic format for editor compatibility.",
    label_chat_instructions: "Converse with the IA to refine the relief (e.g. 'Make the crown points taller' or 'Remove the gap on the front face'):",
    placeholder_chat_input: "Describe what you want to adjust...",
    btn_adjust_relief: "Adjust with IA",
    btn_adjusting_relief: "Adjusting...",
    label_ai_offsets: "AI-Decided Gap (Offsets)",
    face_right: "Right",
    face_left: "Left",
    face_top: "Top",
    face_bottom: "Bottom",
    ...
    face_back: "Back",
    offset_gap: "Gap (4.15)",
    offset_flush: "Flush (4.0)",
    chat_ai_initial_fallback: "I have analyzed your skin overlay and generated the custom 3D voxel heights and face gaps.",
    chat_ai_adjust_fallback: "I have adjusted the 3D relief heightmap and gaps according to your requirements.",
    chat_user_generate_initial: "Generate 3D voxel relief & dynamic face gaps",
  },
  es: {
    // Header
    nav_dashboard: "Panel",
    ...
    // Voxel Relief / IA
    relief_classic: "Capa plana (Clásico)",
    relief_ai: "Relieve Voxel 3D (IA)",
    openai_key_label: "Clave API de OpenAI",
    openai_key_placeholder: "sk-proj-...",
    btn_generate_relief: "Generar Relieve con IA",
    btn_generating_relief: "Generando Relieve...",
    toast_api_key_required: "Se requiere una clave API de OpenAI para generar el relieve.",
    toast_ai_relief_success: "¡Relieve voxel 3D personalizado generado con éxito!",
    toast_ai_relief_error: "Error al generar el relieve con IA: {error}",
    relief_description: "Ingresa tu clave API de OpenAI para calcular automáticamente la profundidad de los voxels usando GPT-4o-mini. La clave se almacena localmente en tu navegador y se envía directamente a OpenAI.",
    relief_export_note: "Nota: El relieve 3D se exportará en formatos OBJ, FBX y GLB. Las exportaciones de BBModel seguirán en formato clásico para compatibilidad con editores.",
    label_chat_instructions: "Conversa con la IA para ajustar el relieve (ej. 'Haz las puntas de la corona más altas' o 'Quita el hueco en la cara frontal'):",
    placeholder_chat_input: "Describe qué quieres ajustar...",
    btn_adjust_relief: "Ajustar con IA",
    btn_adjusting_relief: "Ajustando...",
    label_ai_offsets: "Separación/Huecos decididos por la IA",
    face_right: "Derecha",
    face_left: "Izquierda",
    face_top: "Superior",
    ...
    face_front: "Frontal",
    face_back: "Posterior",
    offset_gap: "Separado (4.15)",
    offset_flush: "Alineado (4.0)",
    chat_ai_initial_fallback: "He analizado las capas de tu skin y generado las alturas de voxel 3D y la separación por cara.",
    chat_ai_adjust_fallback: "He ajustado el mapa de relieve y las separaciones por cara según tus instrucciones.",
    chat_user_generate_initial: "Generar relieve 3D y separación dinámica de caras",
  }
};
